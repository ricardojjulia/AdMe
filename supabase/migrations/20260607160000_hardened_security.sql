...
VALUES
('a0e0a0e0-a0e0-a0e0-a0e0-a0e0a0e0a0e1', 'sarah@adme.demo', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name": "Sarah (Tech Dev)", "account_type": "consumer"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, 'authenticated', 'authenticated'),
('a0e0a0e0-a0e0-a0e0-a0e0-a0e0a0e0a0e2', 'marcus@adme.demo', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name": "Marcus (Local Foodie)", "account_type": "consumer"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, 'authenticated', 'authenticated'),
('a0e0a0e0-a0e0-a0e0-a0e0-a0e0a0e0a0e3', 'elena@adme.demo', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name": "Elena (New Consumer)", "account_type": "consumer"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, 'authenticated', 'authenticated'),
('00000000-0000-0000-0000-000000000001', 'valor@adme.demo', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name": "Valor Brews (Business)", "account_type": "business"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, 'authenticated', 'authenticated'),
('a0e0a0e0-a0e0-a0e0-a0e0-a0e0a0e0a0f5', 'workstation@adme.demo', extensions.crypt('password123', extensions.gen_salt('bf')), now(), '{"full_name": "WorkStation (Business)", "account_type": "business"}'::jsonb, '{"provider": "email", "providers": ["email"]}'::jsonb, 'authenticated', 'authenticated')
